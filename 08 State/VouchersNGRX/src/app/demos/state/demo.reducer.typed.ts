...
export const getShowFilter = createSelector(getDemoFeatureState, (state) => state.showFilter);

export const getFavFood = createSelector(getDemoFeatureState, (state) => state.favFood);

export const getCurrentVoucher = createSelector(getDemoFeatureState, (state) => state.currVoucherId);

export const getAllVouchers = createSelector(getDemoFeatureState, (state) => state.vouchers);

//Reducer
//Use this until before Action Creators
...
//Use this until starting with Action Creators
